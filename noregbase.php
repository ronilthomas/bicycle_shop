...
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <a style="color: black;" id="registerlink" href="register.php" class="card-link">Register Now</a>
</div> <!-- was form -->
  ...
  <header>
    ...
    <ul>  
      ...
      <!-- <li class="list-group-item float-right"><a href="register.php">Register</a> -->
